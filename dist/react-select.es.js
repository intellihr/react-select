...
var Async = function (_Component) {
	...
	createClass(Async, [{
		...
		value: function loadOptions(inputValue) {
			...
			if (cache && Object.prototype.hasOwnProperty.call(cache, this._inputValue)) {
				this._callback = null;
			...
			var callback = function callback(error, data) {
				...
				var input = data && data.input || _this2._inputValue;
			...
			var promise = loadOptions(this._inputValue, callback);
			if (promise) {
